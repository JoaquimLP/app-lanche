...
<div wire:ignore class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-300">
            ...
            <div class="modal-body">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active mb-3" id="nav-home-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="true"><i class="fas fa-motorcycle me-2"></i>Adicione o seu endereço</button>
                ...
                <div class="tab-content mt-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                        ...
                        <div class="row g-3 ">
                            @include("livewire.site.form.form")
                        </div>
                    </div>
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="row g-3 ">
                            @include("livewire.site.form.form-produto")
                        </div>
                    </div>
                </div>
            </div>
